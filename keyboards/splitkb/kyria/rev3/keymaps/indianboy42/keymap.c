...
const key_override_t *key_overrides[] = {KEY_OVERRIDE_TABLE(X_LIST) NULL};
...
// clang-format off
#define LAYOUT_KYRIA(KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, TH_LPRN, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_UNDS, TH_LCBR, KC_Z, KC_X, KC_C, KC_V, KC_B, ALT_RBR, KC_BTN1, KC_BTN2, CTL_BSP, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, TH_QUOT, KC_LGUI, ALT_BSP, KC_LSFT, SYM, CTL_ESC, SFT_ENT, NAV_SPC, ALT_TAB, CTL_DEL, CSA_DEL) LAYOUT_split_3x6_5(KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, TH_LPRN, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_UNDS, TH_LCBR, KC_Z, KC_X, KC_C, KC_V, KC_B, ALT_RBR, KC_BTN1, KC_BTN2, CTL_BSP, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, TH_QUOT, KC_LGUI, ALT_BSP, KC_LSFT, SYM, CTL_ESC, SFT_ENT, NAV_SPC, ALT_TAB, CTL_DEL, CSA_DEL)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTYP] = LAYOUT_KYRIA(
     ...
     TH_LCBR, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    ALT_RBR, KC_BTN1, KC_BTN2, CTL_BSP, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, TH_QUOT,
                                KC_LGUI, ALT_BSP, KC_LSFT, SYM,     CTL_ESC, SFT_ENT, NAV_SPC, ALT_TAB, CTL_DEL, CSA_DEL
    ),
    ...
    [_QWERTY] = LAYOUT_KYRIA(
     ...
     TH_LCBR, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    ALT_SPC, KC_BTN1, KC_BTN2, CTL_BSP, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, FUN_F1,
                                KC_LGUI, ALT_BSP, KC_LSFT, SYM,     CTL_ESC, SFT_ENT, NAV_SPC, ALT_TAB, SYM_DEL, CSA_DEL
    ),
...
#undef X_NAME
#define X_NAME(N, ...) COMBO_##N
#undef X_ENUM
#define X_ENUM(N, A, B, C) X_NAME(N, A, B, C),
#define X_name(N, A, B, C) combo_##N
